...
parmys_arch -a /home/ljw/VTR/vtr_work/mywork/bgm/EArch.xml
...
if {$env(PARSER) == "surelog" } {
	...
	read_systemverilog -debug bgm.v

} elseif {$env(PARSER) == "default" } {

	puts "Using Yosys read_verilog command"

	read_verilog -sv -nolatches bgm.v
...
parmys -a /home/ljw/VTR/vtr_work/mywork/bgm/EArch.xml -nopass -c odin_config.xml
...
write_blif -true + vcc -false + gnd -undef + unconn -blackbox bgm.parmys.blif
